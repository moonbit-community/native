...
void* moonbit_native_malloc(uint64_t size) {
  return malloc(size);
}

void moonbit_native_free(void* ptr) {
  free(ptr);
}
...
void* moonbit_native_null_pointer() {
  return NULL;
}
...
int8_t moonbit_native_int8_pointer_get(void* ptr) {
  return *(int8_t*)ptr;
}
...
int16_t moonbit_native_int16_pointer_get(void* ptr) {
  return *(int16_t*)ptr;
}
...
int32_t moonbit_native_int32_pointer_get(void* ptr) {
  return *(int32_t*)ptr;
}
...
int64_t moonbit_native_int64_pointer_get(void* ptr) {
  return *(int64_t*)ptr;
}
...
uint8_t moonbit_native_uint8_pointer_get(void* ptr) {
  return *(uint8_t*)ptr;
}
...
float moonbit_native_float_pointer_get(void* ptr) {
  return *(float*)ptr;
}
...
double moonbit_native_double_pointer_get(void* ptr) {
  return *(double*)ptr;
}
